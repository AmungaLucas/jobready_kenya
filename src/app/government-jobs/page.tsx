        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              {/* Quick stats */}
              <div>
                <h3 className="text-sm font-bold text-gray-700 mb-3">Government Overview</h3>
              ...
              <div>
                <h3 className="text-sm font-bold text-gray-700 mb-3">Government Employers</h3>
              ...
              {/* Browse by County */}
              <div>
                <h3 className="text-sm font-bold text-gray-700 mb-3">Gov Jobs by County</h3>
