...
import { getGovernmentJobs, getGovernmentOrgs, getGovernmentJobCounts, GOV_TYPE_LABELS } from '@/lib/government';
...
export default async function GovernmentJobsPage({ searchParams }: GovJobsPageProps) {
  ...
  const [jobsData, orgs, counts, allCategories, locations] = await Promise.all([
